    ...
    <section id='story' className={styles.story}>
      <div className={styles.wrap}>
        <h3 className={styles.title}>
          とっておきの甘い時間を<br/>大切な人と。
        </h3>
        <p className={styles.text}>
          ふんわり香る焼きたてのスポンジ、 口どけなめらかな生クリーム、<br/>こだわりの素材を使ったケーキが、特別なひとときを彩ります。<br/>落ち着いた空間で、香り高い紅茶とともに、贅沢なティータイム<br/>をお友達とご家族と大切な人と一緒に。<br/>あなたの街で幸せな時間をお過ごしください。
        </p>
        <Image

      ...
      <div className={styles.wrap}>
        ...
        <div className={`${styles['info-wrap']} ${styles['shortcake']}`}>
            ...
            <div className={`${styles['cake-info']} ${styles['shortcake-info']}`}>
              <p className={styles['cake-title']}>ふんわり贅沢なショートケーキ！</p>
              <p className={styles['cake-content']}>ふわふわのスポンジに、甘さ控えめの生クリームと新鮮ないちごを<br />サンドした王道のショートケーキ。<br />やさしい甘さといちごの酸味が口いっぱいに広がります。<br />ティータイムやお祝い、自分へのご褒美にぴったりの一品です。</p>
              <table className={styles.table}>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className={styles.data}>卵・乳成分・小麦・ゼラチン・いちご</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div className={`${styles['info-wrap']} ${styles['cheesecake']}`}>
            <Image
              ...
              height={314}
            />
            <div className={`${styles['cake-info']} ${styles['cheesecake-info']}`}>
              <p className={styles['cake-title']}>クリーミーな極上チーズケーキ！</p>
              <p className={styles['cake-content']}>濃厚でなめらかな口どけが魅力の特製チーズケーキ。<br />厳選したクリームチーズのコクと、ほどよい酸味が絶妙にマッチ。<br />タルトのサクサク感とともに、贅沢な味わいをお楽しみいただけます。<br />ひとくちごとに広がる深いコクが、心まで満たしてくれる一品です。</p>
              <table className={styles.table}>
                <tbody>
                  <tr>
                    <th className={styles.header}>値段</th>
          ...
          <div className={`${styles['info-wrap']} ${styles['chocolatecake']}`}>
            <Image
              ...
              height={484}
            />
            <div className={`${styles['cake-info']} ${styles['chocolatecake-info']}`}>
              <p className={styles['cake-title']}>濃厚×爽やか 至福のチョコケーキ！</p>
              <p className={styles['cake-content']}>いちごの甘酸っぱさと、とろける濃厚チョコが奏でる贅沢なハーモニー。<br />ふんわりチョコスポンジに、自家製ガナッシュとフレッシュいちごを たっぷりトッピング。<br /> 華やかな見た目で、パーティーやご褒美にもぴったり。<br />今だけの特別な味わいを、心まで甘く染まるひとときとともに。</p>
              <table className={styles.table}>
                <tbody>
                  <tr>
                    <th className={styles.header}>値段</th>
          ...
          <div className={`${styles['info-wrap']} ${styles['canele']}`}>
            ...
            <div className={`${styles['cake-info']} ${styles['canele-info']}`}>
              ...
              <p className={styles['cake-content']}>外はカリッと香ばしく、中はもっちりしっとり。<br /> ラム酒とバニラがふわりと香る、奥深い味わいのフランス伝統菓子。<br /> ひとくちで広がる甘さと香りが、日常にささやかな贅沢を添えます。<br />コーヒーや紅茶と一緒に、心とろけるひとときをどうぞ。</p>
              <table className={styles.table}>
                <tbody>
                  <tr>
                    <th className={styles.header}>値段</th>

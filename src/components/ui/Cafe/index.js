    ...
    <section className={styles.cafe}>
      <div className={styles.wrap}>
        <div className={styles.contents}>
          ...
          <p className={styles.message}>紅茶の香りに包まれながら、心ほどける午後のひとときを。 <br />アフタヌーンティーは、季節のスイーツや軽食を少しずつ楽しめる贅沢なご褒美時間。<br />色とりどりのケーキや焼き菓子を、お気に入りの紅茶とともに優雅な空間でゆったりと味わえます。<br />お友達とのおしゃべりや、大切な人との記念日にもぴったり。<br />忙しい日常を忘れて、ちょっと特別な午後を過ごしてみませんか？</p>
        </div>
        <Image
